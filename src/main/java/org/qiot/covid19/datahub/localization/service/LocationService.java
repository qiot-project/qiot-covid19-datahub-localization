...
public class LocationService {
	...
	public Location translateCoordinates(double longitude, double latitude) throws Exception {

		JsonObject jsonResult = serviceClient.reverse("json", longitude, latitude);
